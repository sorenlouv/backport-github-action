...
exports.commitByShaMock = void 0;
exports.commitByShaMock = {
    sha: 'myCommitSha',
    commit: {
        author: {
        ...
        tree: {
            ...
            url: 'https://api.github.com/repos/elastic/kibana/git/trees/ce129055d52748ed4d931cbc1591d984d71ec04f',
        },
    ...
    comments_url: 'https://api.github.com/repos/elastic/kibana/commits/myCommitSha/comments',
    author: {
        login: 'sqren',
        id: 209966,
    ...
    parents: [
        {
            ...
            url: 'https://api.github.com/repos/elastic/kibana/commits/b81fd782c7a63bc231b4678aa4e685c2025fa302',
            html_url: 'https://github.com/elastic/kibana/commit/b81fd782c7a63bc231b4678aa4e685c2025fa302',
        },
    ],
    stats: {
        total: 2,
    ...
    files: [
        {
            ...
            deletions: 1,
            changes: 2,
            blob_url: 'https://github.com/elastic/kibana/blob/myCommitSha/src/ui/public/chrome/chrome.js',
            raw_url: 'https://github.com/elastic/kibana/raw/myCommitSha/src/ui/public/chrome/chrome.js',
            contents_url: 'https://api.github.com/repos/elastic/kibana/contents/src/ui/public/chrome/chrome.js?ref=myCommitSha',
            patch: "@@ -48,5 +48,5 @@ translationsApi(chrome, internals);\n \n chrome.bootstrap = function () {\n   chrome.setupAngular();\n-  angular.bootstrap(document, ['kibana']);\n+  angular.bootstrap(document.body, ['kibana']);\n };",
        },
    ],
};
