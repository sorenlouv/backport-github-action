...
describe('fetchCommitByPullNumber', () => {
    ...
    describe('when PR exists', () => {
        it('throws an error', async () => {
            ...
            expect(await fetchCommitByPullNumber_1.fetchCommitByPullNumber(options)).toEqual({
    ...
    describe('when PR has not been merged', () => {
        it('throws an error', async () => {
            ...
            await expect(fetchCommitByPullNumber_1.fetchCommitByPullNumber(options)).rejects.toThrowError(`The PR #11 is not merged`);
        });
    });
    describe('when PR does not exist', () => {
        it('throws an error', async () => {
            ...
            await expect(fetchCommitByPullNumber_1.fetchCommitByPullNumber(options)).rejects.toThrowError(`Could not resolve to a PullRequest with the number of 9999999999999. (Github v4)`);
        });
    });
});
