...
const fetchPullRequestBySearchQueryMock_1 = require("./mocks/fetchPullRequestBySearchQueryMock");
describe('fetchPullRequestBySearchQuery', () => {
    let res;
    let mockCalls;
    beforeEach(async () => {
        mockCalls = nockHelpers_1.mockGqlRequest({
            name: 'PullRequestBySearchQuery',
            statusCode: 200,
            body: fetchPullRequestBySearchQueryMock_1.fetchPullRequestBySearchQueryMock,
        });
        res = await fetchPullRequestBySearchQuery_1.fetchPullRequestBySearchQuery({
    ...
    it('should make request with correct variables', () => {
        ...
        expect(mockCalls[0].variables).toEqual({
            maxNumber: 10,
            query: 'type:pr is:merged sort:updated-desc repo:elastic/kibana author:sqren label:Team:apm base:master',
        });
    });
