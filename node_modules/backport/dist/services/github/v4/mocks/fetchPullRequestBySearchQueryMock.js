...
exports.fetchPullRequestBySearchQueryMock = void 0;
exports.fetchPullRequestBySearchQueryMock = {
    data: {
        search: {
            nodes: [
                {
                    ...
                    mergeCommit: {
                        ...
                        message: '[APM] Fix timeout in APM setup (#58727)\n\n* [APM] Fix timeout in APM setup\r\n\r\n* Update plugin.ts',
                    },
                },
                {
                    number: 58467,
                ...
                },
                {
                    ...
                    mergeCommit: {
                        ...
                        message: '[APM] Quick fix for ACM to ensure more than 10 items are displayed (#52262)\n\n* [APM] Quick fix for ACM to ensure more than 10 items are displayed\r\n\r\n* Fix snapshot',
                    },
                },
                {
                    number: 53775,
                ...
                },
                {
                    ...
                    mergeCommit: {
                        ...
                        message: '[APM] Show loading state on waterfall and avoid re-fetching distribution chart when changing bucket (#44093)',
                    },
                },
            ],
        },
