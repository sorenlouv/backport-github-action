...
const execOptions = { stdio: 'pipe', encoding: 'utf-8' };
describe('CLI blackbox', () => {
    ...
    it('should return error when branch is missing', () => {
        const res = runBackport(`--upstream foo --username sqren --accessToken ${devAccessToken}`);
    ...
    it('should return error when upstream is missing', () => {
        const res = runBackport(`--branch foo --username sqren --accessToken ${devAccessToken}`);
        expect(res).toMatchInlineSnapshot(`
    ...
    it(`should return error when repo doesn't exist`, () => {
        const res = runBackport(`--branch foo --upstream foo/bar --username sqren --accessToken ${devAccessToken}`);
        expect(res).toMatchInlineSnapshot(`
